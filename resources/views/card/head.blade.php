<head>
    <!-- title -->
    <title>Shop Giao</title>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge" />
    <meta name="viewport" content="width=device-width,initial-scale=1.0" />
    <meta name="author" content="giaodaica">
    <!-- description -->
    <meta name="description"
        content="Mua quần áo thời trang đẹp, chất lượng tại giaoshop. Cập nhật xu hướng mới nhất với áo thun, váy, quần jeans, phụ kiện phong cách.">
    <meta name="keywords"
